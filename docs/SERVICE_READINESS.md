...
Complete F02–F05 PR/CI/Beta runtime verification, then implement F06–F07. Physical PDA/UI/FCM/ACK acceptance remains separate. Stable remains Owner-gated.
