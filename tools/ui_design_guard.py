...
checks = {
    ...
    "android_d074_picker_split_behavior": all(token in ANDROID_PICKER for token in ["showOperationTab(confirm = false)", "showOperationTab(confirm = true)", "digits.length == 5", "InputMethodManager.SHOW_IMPLICIT", "R.id.tabShortage", "R.id.tabConfirmOrder"]),
