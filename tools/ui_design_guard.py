...
checks = {
    ...
    "android_narrow_header_no_fixed_meta_column": "screenWidthDp" in ANDROID_UI and "LinearLayout.LayoutParams(dp(134)" not in ANDROID_UI,
    "android_reporter_no_squeezed_picker_button": "Xem Picker ›" not in ANDROID_REPORTER and "setOnClickListener { showTickets(row) }" in ANDROID_REPORTER,
    "android_picker_catalog_status_compact": "catalogLabel?.visibility = View.GONE" in ANDROID_PICKER,
