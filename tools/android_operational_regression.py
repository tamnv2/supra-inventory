...
def main() -> None:
    ...
    require(firestore_transport, "PrimaryPollIntervalMs = 2000", "D115 PRIMARY 2-second healthy-path polling")
    ...
    require(relay_agent_config, "AgentBuild = 34", "D115 Agent build channel")
