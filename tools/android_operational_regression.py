...
def main() -> None:
    ...
    require(relay_agent_config, "AgentBuild = 9", "D084 Agent build channel")
    ...
    require(status_overlay, "WsExTransparent", "D084 cross-application click-through style")
    require(status_overlay, "ApplyClickThroughStyle", "D084 dynamic click-through toggle")
    require(status_overlay, "style &= ~(WsExTransparent | WsExNoActivate)", "D084 unlock restores interaction")
