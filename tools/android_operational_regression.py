...
def main() -> None:
    ...
    require(relay_agent_config, "AgentBuild = 10", "D085 Agent build channel")
    ...
    # D085 intentionally restores the Owner-field-proven v8 overlay interaction engine.
    require(status_overlay, "HtTransparent", "D085 v8 locked hit-test pass-through")
    forbid(status_overlay, "SetWindowLong", "D085 v9 overlay extended-style regression")
    require(relay_agent, '"Cài đặt bảng nổi"', "D085 main-window overlay settings access")
