...
def main() -> None:
    ...
    require(firestore_transport, "PrimaryPollIntervalMs = 3000", "D116 PRIMARY 3-second quota-balanced polling")
    ...
    require(relay_agent_config, "AgentBuild = 35", "D116 Agent build channel")
