...
def main() -> None:
    ...
    require(app, "patchOverlays();\n    void commitReporterResolution(batch, \"HAS_STOCK\")", "D071 immediate HAS_STOCK modal close")
    require(app, "patchOverlays();\n    void commitReporterResolution(batch, \"SKIP_ALLOWED\")", "D071 immediate Skip modal close")
